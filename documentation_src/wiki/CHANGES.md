...
2. **Enhanced Runtime Sub-Agents Section**:
   - Added sub-agent positioning examples (Debugger, Retrieval, Fuzzer, Memory agents)
   - Expanded on agent topology and dynamic graph concepts
   - Clarified agent ensemble capabilities

3. **Added System-Level Workflow Section** (NEW - Planned Feature):
   - Rule-based execution model
   - Graph-based scheduling
   - Pub-sub event-driven coordination
   - Note: Feature is planned, placeholder documentation created

4. **Added Memory as Manageable System Resource Section** (NEW - Planned Feature):
...
3. **_Sidebar.md**:
   - Updated to include links to new System-Workflow and Memory-System pages
